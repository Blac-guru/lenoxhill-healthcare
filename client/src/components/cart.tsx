...
export default function Cart({ isOpen, onClose }: CartProps) {
  ...
  const orderMutation = useMutation({
    mutationFn: async (
      data: typeof checkoutData & { total: string; items: string },
    ) => {
        ...
        <div className="flex flex-col h-full">
          {cartItemsWithProducts.length === 0 ? (
            <div className="flex-1 flex items-center justify-center">
              <p className="text-gray-500" data-testid="text-cart-empty">
                Your cart is empty
              </p>
            </div>
          ) : (
                  ...
                  >
                    <img
                      src={
                        ...
                        "https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&h=100"
                      }
              ...
              <div className="border-t pt-4 space-y-4">
                <div className="flex justify-between items-center">
                  <span
                    ...
                    data-testid="text-cart-total-label"
                  >
                    Total:
                  </span>
                  <span
                    className="font-bold text-lg text-healthcare-blue-600"
