      ...
      >
        <DialogHeader>
          ...
          <DialogDescription
            ...
            data-testid="modal-product-category"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="space-y-4">
            <div className="aspect-square bg-gray-100 rounded-lg overflow-hidden">
              <img
                src={
                  product.imageUrl ||
                  "https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=600"
                }
                alt={product.name}
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {product.prescriptionRequired && (
                <Badge
                  ...
                  data-testid="modal-prescription-badge"
                >
          ...
          <div className="space-y-6">
            <div
              className="text-3xl font-bold text-healthcare-blue-600"
            ...
            <div>
              <h3
                ...
                data-testid="modal-features-title"
              >
                Quality Assurance
              </h3>
              <ul className="space-y-2">
                {features.map((feature, index) => (
                  <li
                    ...
                    data-testid={`modal-feature-${index}`}
                  >
            ...
            {product.prescriptionRequired && (
              <div
                ...
                data-testid="modal-prescription-warning"
              >
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-orange-700">
                      ...
                      licensed healthcare provider. Please ensure you have your
                      prescription ready before purchasing.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                <div className="flex items-center border border-gray-300 rounded-lg">
                  ...
                  <span
                    ...
                    data-testid="modal-quantity-display"
                  >
                    {quantity}
                  </span>
                  <Button
                ...
                <Button
                  ...
                  className={`flex items-center ${wishlisted ? "text-red-600 border-red-200" : "text-gray-600"}`}
                  data-testid="modal-wishlist-button"
                >
                  <Heart
                    className={`w-4 h-4 mr-2 ${wishlisted ? "fill-current" : ""}`}
                  />
            ...
            <div
              ...
              data-testid="modal-additional-info"
            >
